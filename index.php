	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>Arifur Rahman</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:rahman15-6168@s.diu.edu.bd.com" style="color:white">rahman15-6168@s.diu.edu.bd.com</a></p>
			</div>
		</div>
